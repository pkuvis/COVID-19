...
def checkv4_Main(mergeDataFile,data_dir):
    ...
    '''
    merge_reslut=check_xlsx_data(data_dir)

    return outputfile,merge_reslutimport numpy as np
import pandas as pd
import csv
import os
from pandas import DataFrame
...
if __name__ == "__main__":
    checkv4_Main('MergeData_20200228_11-22-00.csv','../tempdata/fujianCaseStatistics_20200303.xlsx')
    #check.checkMain('merge_withCuredUpdate7.csv','./log')